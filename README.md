...
- Double‑click **DeskReminder.bat** to launch the application without a console window.
- A desktop shortcut (`DeskReminder.lnk`) can be created manually pointing to the batch file.
...
The generated `main.exe` can be placed anywhere and run directly.
